...
export const metadata: Metadata = {
  title: "Contact Us | Click Urban",
  description: "Get in touch with the Click Urban team for support, inquiries, or partnerships.",
};
          ...
          <div className="space-y-6 mb-8">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">support@clickurban.com</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            ...
            },
            {
              ...
              answer: "Yes, we ship to most countries worldwide. Shipping costs and delivery times vary by location. You can see the shipping options available to your country during checkout."
            },
            {
              question: "How can I become a vendor on Click Urban?",
              answer: "We're always looking for quality vendors to join our platform. Please contact our partnerships team at partners@clickurban.com with details about your products."
            },
          ].map((faq, index) => (

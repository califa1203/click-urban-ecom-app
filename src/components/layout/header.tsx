    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-background/80 backdrop-blur-sm">
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link 
            href="/auth/login" 
            className="hidden md:flex items-center gap-1 px-3 py-1.5 text-sm font-medium rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        <div className="md:hidden border-t border-border">
          <div className="container py-4">
            ...
            <nav className="flex flex-col gap-4">
              ...
              <Link
                href="/auth/login"
                className="flex items-center gap-1 px-3 py-2 text-sm font-medium rounded-md bg-primary text-primary-foreground hover:bg-primary/90 transition-colors"
                onClick={() => setIsMenuOpen(false)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
